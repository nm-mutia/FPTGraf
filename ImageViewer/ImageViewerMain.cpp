...
BEGIN_EVENT_TABLE(ImageViewerDialog, wxDialog)
    EVT_CLOSE(ImageViewerDialog::OnClose)
    EVT_BUTTON(idBtnQuit, ImageViewerDialog::OnQuit)
    EVT_BUTTON(idBtnAbout, ImageViewerDialog::OnAbout)
END_EVENT_TABLE()

ImageViewerDialog::ImageViewerDialog(wxDialog *dlg, const wxString &title)
...
void ImageViewerDialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}

void ImageViewerDialog::OnQuit(wxCommandEvent &event)
{
    Destroy();
}

void ImageViewerDialog::OnAbout(wxCommandEvent &event)
{
